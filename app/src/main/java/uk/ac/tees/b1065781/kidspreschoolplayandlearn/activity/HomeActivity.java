...
import uk.ac.tees.b1065781.kidspreschoolplayandlearn.adapter.HomeCategoriesAdapter;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        if(type==1){
            txtExamTitle.setText(R.string.preschool_kids_learning);
        }else if(type==2){
            txtExamTitle.setText(R.string.look_and_choose_quiz);
        }else if(type==3){
            txtExamTitle.setText(R.string.listen_and_guess);
        }
